                            ...
                            <div class="table-responsive" style="border-top: 2px solid #ececec;">
                                <table class="table table-striped table-hover table-bordered text-center">
                                    ...
                                    <tr v-for="employee in filterserch" :key="employee.id">
                                        ...
                                        <td>
                                            <router-link :to="{name:'edit-employee' ,params:{id:employee.id}}"><i class="fa fa-edit"></i></router-link>
                                            <a href="" class="text-success" ><i class="fa fa-eye"></i></a>
                                            <a @click="deleteEmp(employee.id)" href="#" class=" text-danger "><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
