                ...
                <div class="col-sm-12">
                    <div class="panel">
                        <div class="panel-content">
                            <p class="pull-left"><span class="badge x-success">Total Product Qty = {{totalQty}} , Total Product Value =Tk {{ totalValue }}</span></p>
    ...
    computed:{
        ...
        totalQty(){
            ...
            for(let i = 0; i < this.allProduct.length; i++){
                sum += (parseFloat(this.allProduct[i].product_quantity));
            }
            return sum;
        },
        totalValue(){
            ...
            let sum = 0;
            for(let i = 0; i < this.allProduct.length; i++){
                if(this.allProduct[i].product_quantity > 0)
                {
                    sum += (parseFloat(this.allProduct[i].selling_price) * parseFloat(this.allProduct[i].product_quantity));
                }
